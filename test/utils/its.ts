...
export async function globeDepositWithdraw(assetContract: Contract, SnowGlobe: Contract, walletSigner: Signer, txnAmt = "250000000000000000000000000") {
...
export async function strategyLoadedWithBalance(assetContract: Contract, SnowGlobe: Contract, Strategy: Contract, walletSigner: Signer, txnAmt = "250000000000000000000000000") {
